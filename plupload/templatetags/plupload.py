    ...
    def render(self, context):
        ...
        <div id="uploader_cont">
            ...
            <div id="upload_buttons">
                <button id="uploadfiles_table" class="default_button_upload hidden">Subir Archivos</button>
                <button id="pickfiles" class="default_button_upload">Seleccionar Archivos</button>
            </div>
            </div>
