...
class SectoralTypeAdmin(admin.ModelAdmin):
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s sectores fueron marcados como desactivados"\
                          % rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s sectores fueron marcados como eliminados" \
                          "(ocultos)" % rows_updated
        self.message_user(request, message_bit)
...
class ClusterAdmin(admin.ModelAdmin):
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s clusters fueron marcados como desactivados"\
                          % rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s clusters fueron marcados como eliminados" \
                          "(ocultos)" % rows_updated
        self.message_user(request, message_bit)
...
class CompanyAdmin(admin.ModelAdmin):
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Las %s empresas fueron marcados como desactivadas"\
                          % rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Las %s empresas fueron marcadas como eliminadas" \
                          "(ocultas)" % rows_updated
        self.message_user(request, message_bit)
...
class BuildingAdmin(admin.ModelAdmin):
    list_display = ['building_name', 'building_formatted_address',
                    'building_status', 'pais', 'estado', 'municipio']
    list_filter = ['pais', 'estado', 'municipio', 'building_status']
    actions = ["make_active", "make_inactive", "mark_deleted"]
    # define the raw_id_fields
    raw_id_fields = (
    'pais', 'estado', 'municipio', 'colonia', 'calle', 'region')
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s edificios fueron marcados como " \
                          "desactivados" % rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s edificios fueron marcados como eliminados" \
                          "(ocultos)" % rows_updated
        self.message_user(request, message_bit)
...
admin.site.register(c_center.models.BuildingAttributesForBuilding,
                    BuildingAttributesForBuildingAdmin)
...
class ProfilePowermeterAdmin(admin.ModelAdmin):
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s perfiles fueron marcados como desactivados"\
                          % rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s perfiles fueron marcados como eliminados" \
                          "(ocultos)" % rows_updated
        self.message_user(request, message_bit)
...
class ElectricDeviceTypeAdmin(admin.ModelAdmin):
    ...
    def make_active(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los dispositivos o sistemas fueron marcados como " \
                          "activos"
        self.message_user(request, message_bit)

    make_active.short_description = "Marcar dispositivos o sistemas como " \
                                    "activos"
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s dispositivos o sistemas fueron marcados " \
                          "como desactivados" % rows_updated
        self.message_user(request, message_bit)

    make_inactive.short_description = "Marcar dispositivos o sistemas como " \
                                      "inactivos"

    def mark_deleted(self, request, queryset):
        rows_updated = queryset.update(sectoral_type_status=2)
        if rows_updated == 1:
            message_bit = "El dispositivo o sistema ha sido marcado como " \
                          "eliminado(oculto)"
        else:
            message_bit = "Los %s dispositivos o sistemas fueron marcados " \
                          "como eliminados(ocultos)" % rows_updated
        self.message_user(request, message_bit)

    mark_deleted.short_description = "Marcar dispositivos o sistemas como " \
                                     "eliminados(ocultos)"
...
class PartOfBuildingTypeAdmin(admin.ModelAdmin):
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Las %s partes fueron marcadas como desactivadas" %\
                          rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Las %s partes fueron marcadas como eliminadas" \
                          "(ocultas)" % rows_updated
        self.message_user(request, message_bit)
...
class BuildingTypeAdmin(admin.ModelAdmin):
    ...
    def make_inactive(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s tipos fueron marcados como desactivados" % \
                          rows_updated
        self.message_user(request, message_bit)
    ...
    def mark_deleted(self, request, queryset):
        ...
        if rows_updated == 1:
            ...
            message_bit = "Los %s tipos fueron marcados como eliminados" \
                          "(ocultos)" % rows_updated
        self.message_user(request, message_bit)
...
admin.site.register(c_center.models.ElectricDataTemp, ElectricDataAdmin)
