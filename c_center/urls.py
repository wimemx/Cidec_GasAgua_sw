...
urlpatterns = patterns('',
                       ...
                       url(r'^search_bld_country/',
                           'c_center.views.search_bld_country'),
                       url(r'^search_bld_state/',
                           'c_center.views.search_bld_state'),
                       url(r'^search_bld_municipality/',
                           'c_center.views.search_bld_municipality'),
                       url(r'^search_bld_neighborhood/',
                           'c_center.views.search_bld_neighborhood'),
                       url(r'^search_bld_street/',
                           'c_center.views.search_bld_street'),
)