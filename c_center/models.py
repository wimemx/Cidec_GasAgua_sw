...
class ElectricData(models.Model):
    ...
    V3 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I1 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I2 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I3 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kWL1 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kWL2 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kWL3 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kvarL1 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kvarL2 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kvarL3 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kVAL1 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kVAL2 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kVAL3 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    PFL1 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    PFL2 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    PFL3 = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kW = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kvar = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kVA = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    PF = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    In = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    FREQ = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kWIMPSDMAX = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kWIMPACCDMD = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kVASDMAX = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    kVAACCDMD = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I1DMDMAX = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I2DMDMAX = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I3DMDMAX = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    ...
    I1THD = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I2THD = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    I3THD = models.DecimalField(max_digits=12, decimal_places=6, null=True, blank=True)
    def __unicode__(self):
